package com.biz.memoapp;

import android.os.Bundle;

import com.biz.memoapp.adapter.MemoViewAdapter;
import com.biz.memoapp.adapter.MemoViewModel;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextInputEditText text_input_memo = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_input_memo = findViewById(R.id.m_input_text);
        ...
        // DB 연동을 위한 준비
        // 2.2.0-beta01 ViewModelProvider 사용
        ...
        /*
            ...
            onChanged() method에서 데이터를 화면에 보여주는 코드를 작성
         */
...
//        ).get(MemoViewModel.class);
        ...
        DividerItemDecoration itemDecoration
                ...
                memo_list_view.getContext(),
                LinearLayoutManager.VERTICAL);
        itemDecoration.setDrawable(
                this.getResources().getDrawable(
                        R.drawable.decoration_line,
    ...
    public void onClick(View v) {
        ...
        String m_memo_text = text_input_memo.getText().toString();
        if (m_memo_text.isEmpty()) {
            Toast.makeText(MainActivity.this, "메모입력", Toast.LENGTH_SHORT).show();
            text_input_memo.setFocusable(true);
            return;
        }
...
//        memoList.add(memoVO);
//
//        // RecyclerView의 Adapter한테 데이터가 변경되었으니 리스트를 다시 그려라 통보
//        view_adapter.notifyDataSetChanged();

        text_input_memo.setText("");
    }
}
