package com.biz.myapp03.ui.home;
...
//        final TextView textView = root.findViewById(R.id.text_home);
        textView1 = root.findViewById(R.id.text_name);
        textView2 = root.findViewById(R.id.text_tel);
    ...
    public void onClick(View v) {
        // EditText는 getText() method로 값을 추출
        // TextInputEditText는 getText().toString() 연결해야 정상적인 문자열 추출가능
        String strName = textView1.getText().toString();
        String strTel = textView2.getText().toString();

        // btn_save 버튼이 클릭되었을때만 반응하기
        int id = v.getId();
        if (id == R.id.btn_save) {
